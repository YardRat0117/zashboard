...
const zh: LANG_MESSAGE = {
    ...
    IPInfoAPI: 'IP信息API',
    IPInfoAPITip: '此API会用于IP检查中全球节点IP信息查询、连接详情中的IP地理信息查询、面板DNS查询中的IP地理信息查询。',
    general: '通用',
    ...
    importFromBackendTip: '默认的./zashboard-settings.json位于ui文件夹下，导入前请确保ui文件夹下存在配置文件。',
    ...
    ruleMissChart: '未命中统计',
    latency: '延迟',
    latencyMethodNote: '注意：延迟通过 favicon.ico 测量，仅供参考。',
    proxyStyle: '代理样式',
    icon: '图标',
