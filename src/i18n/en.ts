const en = {
    ...
    DNSQuery: 'DNS query',
    currentBackendUnavailable: 'The current backend is unavailable. Would you like to switch to another backend?',
    confirm: 'Confirm',
    ...
    hideConnectionTip: 'You can use case-insensitive regular expressions to match and hide unwanted connections.',
    hideLog: 'Hide log',
    showLog: 'Show log',
    ...
    tipForFixed: 'The current policy group is locked to the current node. Run a speed test to restore {type} behavior.',
    ...
    latency: 'Latency',
    latencyMethodNote: 'Note: the latency is measured via favicon.ico and should only be for reference.',
