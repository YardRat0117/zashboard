<template>
    <div class="card">
        ...
        <div :class="twMerge('relative h-96 w-full overflow-hidden pt-12')" @mousemove.stop @touchmove.stop>
            ...
            <div
                ...
                <button class="btn btn-ghost btn-circle btn-sm" @click="isPaused = !isPaused">
                    <component :is="!isPaused ? PauseCircleIcon : PlayCircleIcon" class="h-4 w-4" />
                </button>
                <button class="btn btn-ghost btn-circle btn-sm" @click="isFullScreen = !isFullScreen">
    ...
    <Teleport to="body">
        <div
            ...
            <div class="fixed right-4 bottom-4 mb-[env(safe-area-inset-bottom)] flex flex-col gap-1">
                ...
                <button class="btn btn-ghost btn-circle btn-sm" @click="isFullScreen = false">
