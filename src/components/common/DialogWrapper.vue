<template>
    <dialog ref="modalRef" class="modal" @close="isOpen = false">
        ...
        <div
            ...
            <div v-if="title && isOpen" class="border-base-content/10 relative border-b px-4 py-2 text-base font-bold">
                {{ title }}
                <slot name="title-right"></slot>
                <form method="dialog" class="-mr-1">
