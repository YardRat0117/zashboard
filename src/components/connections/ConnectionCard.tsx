...
import { CONNECTION_TAB_TYPE, CONNECTIONS_TABLE_ACCESSOR_KEY, PROXY_CHAIN_DIRECTION } from '@/constant'
import {
        ...
        return (): VNode<RendererNode, RendererElement, { [key: string]: undefined }> => {
            ...
            const componentMap: Record<CONNECTIONS_TABLE_ACCESSOR_KEY, JSX.Element> = {
                ...
                [CONNECTIONS_TABLE_ACCESSOR_KEY.DlSpeed]: (
                    <div class="flex items-center gap-1 text-xs whitespace-nowrap">
                        {prettyBytesHelper(conn.downloadSpeed)}
                        /s
                ...
                [CONNECTIONS_TABLE_ACCESSOR_KEY.UlSpeed]: (
                    <div class="flex items-center gap-1 text-xs whitespace-nowrap">
                        {prettyBytesHelper(conn.uploadSpeed)}
                        /s
            ...
            return (
                <div
                    class={['card cursor-pointer gap-1', connectionCardLines.value.length > 2 ? 'p-2' : 'p-1']}
