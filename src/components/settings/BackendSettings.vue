    ...
    <div v-if="hasVisibleItems" class="flex flex-col gap-2 p-4 text-sm">
        ...
        <template v-if="configs && !hiddenSettingsItems[`${SETTINGS_MENU_KEY.backend}.ports`]">
            ...
            <div
                ...
                <div class="setting-item" v-for="portConfig in portList" :key="portConfig.key">
            ...
            <div
                ...
                <div v-if="!hiddenSettingsItems[`${SETTINGS_MENU_KEY.backend}.allowLan`]" class="setting-item">
                    <div class="setting-item-label">
                        {{ $t('allowLan') }}
                    </div>
                </div>
        ...
        <div
            ...
            <template v-if="displayAllFeatures">
                <button class="btn btn-sm" @click="handlerClickRestartCore">
                    <span v-if="isCoreRestarting" class="loading loading-spinner loading-md"></span>
                    {{ $t('restartCore') }}
                </button>
