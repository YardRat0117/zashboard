<template>
    <div class="flex flex-col gap-4">
        <div class="flex items-center gap-2">
            ...
            <input type="checkbox" class="toggle" v-model="showFullProxyChain" />
        </div>
...
const restOfColumns = ref(
    Object.values(CONNECTIONS_TABLE_ACCESSOR_KEY).filter((key) => !connectionTableColumns.value.includes(key)),
)
</script>
