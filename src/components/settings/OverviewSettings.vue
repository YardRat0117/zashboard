<template>
    ...
    <div v-if="hasVisibleItems" class="flex flex-col gap-2 p-4 text-sm">
        ...
        <div class="settings-grid">
            ...
            <div
                v-if="!hiddenSettingsItems[`${SETTINGS_MENU_KEY.overview}.showStatisticsWhenSidebarCollapsed`]"
...
const hasVisibleItems = computed(() => {
    return (
        ...
        !hiddenSettingsItems.value[`${SETTINGS_MENU_KEY.overview}.showStatisticsWhenSidebarCollapsed`] ||
