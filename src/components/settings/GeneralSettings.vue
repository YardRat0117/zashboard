<template>
    <div v-if="hasVisibleGeneralItems" class="p-4 text-sm">
        <div class="settings-title">
            {{ $t('general') }}
        </div>
        <div class="settings-grid">
            <div v-if="!hiddenSettingsItems[`${SETTINGS_MENU_KEY.general}.autoDisconnectIdleUDP`]" class="setting-item">
                ...
                <input type="checkbox" v-model="autoDisconnectIdleUDP" class="toggle" />
            </div>
            <div
                v-if="
                ...
                <input type="number" class="input input-sm w-20" v-model="autoDisconnectIdleUDPTime" />
                mins
            </div>
            ...
            <div
                ...
                <input type="checkbox" v-model="scrollAnimationEffect" class="toggle" />
            </div>
            <div
                ...
                <input type="checkbox" v-model="swipeInPages" class="toggle" />
            </div>
            <div
                ...
                <input type="checkbox" v-model="swipeInTabs" class="toggle" />
            </div>
            <div
                ...
                <input type="checkbox" v-model="disablePullToRefresh" class="toggle" />
            </div>
            <div v-if="!hiddenSettingsItems[`${SETTINGS_MENU_KEY.general}.displayAllFeatures`]" class="setting-item">
                <div class="setting-item-label">
                ...
                <input type="checkbox" v-model="displayAllFeatures" class="toggle" />
            </div>
        </div>
    </div>
</template>
...
const hasVisibleGeneralItems = computed(() => {
    return (
        ...
        (swipeInPages.value && !hiddenSettingsItems.value[`${SETTINGS_MENU_KEY.general}.swipeInTabs`]) ||
