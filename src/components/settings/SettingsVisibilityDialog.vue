<template>
    <DialogWrapper v-model="isOpen" :title="$t('settingsVisibility')">
        <div class="flex flex-col text-sm">
            <div class="mb-4 flex gap-2">
                <button class="btn btn-sm" @click="applyShowAllPreset">
                    {{ $t('showAllPreset') }}
                </button>
                <button class="btn btn-sm" @click="applyMinimalPreset">
                    {{ $t('minimalPreset') }}
                </button>
            </div>
            <Draggable
                        ...
                        <div class="collapse-content p-0">
                            <div class="max-h-96 overflow-y-auto">
                                <div class="flex flex-col gap-2">
                                    <div v-for="item in category.items" :key="item.key" class="setting-item px-4">
                                        <div class="setting-item-label">
                                            {{ $t(item.label) }}
                                        </div>
                                        <input
                                            ...
                                            @change="
                                                hiddenSettingsItems[item.key] = !($event.target as HTMLInputElement)
                                                    .checked
                                            " />
                                    </div>
                                </div>
