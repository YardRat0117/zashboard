        ...
        return (): VNode<RendererNode, RendererElement, { [key: string]: undefined }> => {
            ...
            const settingsModal = (
                <>
                    ...
                    <DialogWrapper v-model={settingsModel.value} title={t('connectionSettings')}>
                        <div class="flex flex-col gap-4 p-2 text-sm">
                            <div class="flex items-center gap-2">
                                <span class="shrink-0">{t('hideConnectionRegex')}</span>
                                <TextInput class="w-32 max-w-64 flex-1" v-model={quickFilterRegex.value} />
                            </div>
                            <div class="flex items-center gap-2">
                                {t('hideConnection')}
                                <input type="checkbox" class="toggle" v-model={quickFilterEnabled.value} />
                                <div
                                    onMouseenter={(e) =>
                            ...
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    router.push({
                                        ...
                                        query: {
                                            scrollTo: SETTINGS_MENU_KEY.connections,
                                        },
                                    })
                                }}>
                                {t('moreSettings')}
            ...
            const buttons = (
                <>
                    <button
                        ...
                        {quickFilterEnabled.value ? <LinkSlashIcon class="h-4 w-4" /> : <LinkIcon class="h-4 w-4" />}
                    </button>
                    <button
                        class="btn btn-circle btn-sm"
                        onClick={() => {
                    ...
                    <button class="btn btn-circle btn-sm" onClick={handlerClickCloseAll}>
